...
namespace BUS_QLBanHang
{
    public static class BUS_NhanVien
    {
        ...
        public static NhanVien Get(string maNV)
        {
           ...
           public static int Insert(string emai, string tenNV, string diaChi, byte vaiTro, byte tinhTrang, string matKhau)
        {
            return dalNhanVien.Insert(emai, tenNV, diaChi, vaiTro, tinhTrang, matKhau);
        }
